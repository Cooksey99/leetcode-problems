...
departmentId is a foreign key of the ID from the <code style="background: rgb(0, 9, 15) !important;">Department </code>table.
Each row of this table indicates the ID, name, and salary of an employee. It also contains the ID of their department.
</pre>

<p>&nbsp;</p>

<p>Table: <code style="background: rgb(0, 9, 15) !important;">Department</code></p>

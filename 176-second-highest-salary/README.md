...
<p>Write an SQL query to report the second highest salary from the <code style="">Employee</code> table. If there is no second highest salary, the query should report <code style="">null</code>.</p>
